...
| show-alpha         | Boolean           | `true`                                                                                                                                                                                   | Show alpha slider if `true` |
| show-hex-input     | Boolean           | `true`                                                                                                                                                                                   | Show hex input if `true`    |
| show-rgba-input    | Boolean           | `true`                                                                                                                                                                                   | Show rgb input    if `true` |
